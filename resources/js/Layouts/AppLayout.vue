        ...
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link href="/saidas" :active="$page.currentRouteName == 'saidas'">
                                Saídas
                            </jet-nav-link>
                            <jet-nav-link href="/entradas" :active="$page.currentRouteName == 'entradas'">
                                Entradas
                            </jet-nav-link>
                            <jet-nav-link href="/produtos" :active="$page.currentRouteName == 'produtos'">
                                Produtos
                            </jet-nav-link>
                            <jet-nav-link href="/categorias" :active="$page.currentRouteName == 'categorias'">
                                Categorias
                            </jet-nav-link>
                            <jet-nav-link href="/clientes" :active="$page.currentRouteName == 'clientes'">
                                Clientes
                            </jet-nav-link>
                            <jet-nav-link href="/relatorios" :active="$page.currentRouteName == 'relatorios'">
                                Relatórios
                            </jet-nav-link>
                            <jet-nav-link href="/fornecedores" :active="$page.currentRouteName == 'fornecedores'">
                                Fornecedores
                            </jet-nav-link>
                            <jet-nav-link href="/vendedores" :active="$page.currentRouteName == 'vendedores'">
                                Vendedores
                            </jet-nav-link>
                        </div>
                    </div>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <jet-responsive-nav-link href="/saidas" :active="$page.currentRouteName == 'saidas'">
                        Saídas
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/entradas" :active="$page.currentRouteName == 'entradas'">
                        Entradas
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/produtos" :active="$page.currentRouteName == 'produtos'">
                        Produtos
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/categorias" :active="$page.currentRouteName == 'categorias'">
                        Categorias
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/clientes" :active="$page.currentRouteName == 'clientes'">
                        Clientes
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/relatorios" :active="$page.currentRouteName == 'relatorios'">
                        Relatórios
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/fornecedores" :active="$page.currentRouteName == 'fornecedores'">
                        Fornecedores
                    </jet-responsive-nav-link>
                    <jet-responsive-nav-link href="/vendedores" :active="$page.currentRouteName == 'vendedores'">
                        Vendedores
                    </jet-responsive-nav-link>
                </div>
